    ...
    internal static class StreamHelpers
    {
        ...
        internal static string ReadStringInternalDynamic(this Stream stream, Encoding encoding, char end)
        {
            ...
            while (true)
            {
                ...
                {
                    if (data.Length + (128 * characterSize) > 32 * 1024 * 1024)
                    {
                        throw new InvalidDataException("VDF string allocation exceeds limit");
                    }
                ...
                if (i > 32 * 1024)
                {
                    throw new InvalidDataException("VDF string length exceeds limit");
                }
            }
