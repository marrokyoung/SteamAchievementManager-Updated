...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus:outline-none focus:ring-2 focus:ring-primary/65 focus:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 shadow-[0_8px_26px_rgba(0,0,0,0.35)] hover:-translate-y-[1px] active:translate-y-0 backdrop-blur-sm',
  {
    variants: {
      variant: {
